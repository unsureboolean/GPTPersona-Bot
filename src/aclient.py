...
class aclient(discord.Client):
    def __init__(self) -> None:
        ...
        self.activity = discord.Activity(type=discord.ActivityType.listening, name="the Lazy Scranton rap")
    ...
    async def send_message(self, message, user_message):
        ...
        try:
            ...
            if self.is_replying_all == "True":
                await message.channel.send(f"> **Something went wrong, please try again later!** \n ```ERROR MESSAGE: {e}```")
            else:
                await message.followup.send(f"> **Something went wrong, please try again later!** \n ```ERROR MESSAGE: {e}```")
